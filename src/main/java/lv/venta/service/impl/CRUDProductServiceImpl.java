...
@Entity
public class CRUDProductServiceImpl {
	...
	public CRUDProductServiceImpl(String inputTitle, float inputPrice, String inputDescription, Category inputCategory,
			int inputQuantity) {
		setTitle(inputTitle);
		setPrice(inputPrice);
